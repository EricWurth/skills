...
- It uses no scripts and no subagents.
...
rather than hunting. The distinction matters: this skill assumes you are
looking for something to build, not something to fix.

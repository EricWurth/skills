...
- **4. Adversarial review.** Five personas, the engine of the skill. The
  ...
  the author did the job or read about it. It hunts for advice that would
...
- Nothing else. It uses no scripts and no other skills.
...
grounds a position rather than generating one.
